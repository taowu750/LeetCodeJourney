...
public class E38_Medium_CountAndSay {
    ...
    public String countAndSay(int n) {
        ...
        StringBuilder sb = new StringBuilder(CACHE[MAX].length() * 2), sb2 = new StringBuilder(sb.length());
        sb.append(CACHE[MAX]);
